...
- [ ] Use the supplied arena and case artwork on their respective Practice cards and remove the redundant lesson-count sentence.
- [ ] Explain App Store automatic updates versus app-delivered updates accurately, without implying a new version is already available.
