# Release 1.0.8: Leo bubbles, daily entry, no widgets
...
- Create one reusable mobile Leo speech-bubble treatment based on the supplied reference: smooth rounded balloon, clean white or softly tinted surface, subtle outline and shadow, generous text space, and a short organic tail pointing toward Leo.
...
- Bump the mobile release to **1.0.8, build 119**.
