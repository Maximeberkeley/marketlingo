 ...
 */
export function TheCall({ exercise, phase, onChange }) {
    ...
    return (<View style={styles.wrap}>
      ...
      {phase === 'feedback' && !!exercise.consequences?.length && (<View style={styles.wire}>
          {exercise.consequences.slice(0, beats).map((c, i) => (<View key={i} style={styles.wireRow}>
