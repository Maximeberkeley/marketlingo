...
export function LessonScreen({ lesson, onExit, onFinish, xpPerCorrect = 10, renderExtraActions, doneLabel, streakDays, confirmExit = true, marketId, onSaveLeoAnswer, }) {
    ...
    useEffect(() => {
        setNudge(null);
        if (phase !== 'answering' || isInfo || showAskLeo)
            return;
    ...
    return (<View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      {!!nudge && phase === 'answering' && (<TouchableOpacity style={[styles.leoPrompt, { borderColor: world.colors[0] + '55' }]} onPress={() => openLeo('Explain this simpler.')}>
