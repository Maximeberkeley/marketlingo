 ...
 */
export function LeoCoach({ line, mood = 'idle', accent = tokens.color.accent }) {
    ...
    const moodTint = mood === 'correct' || mood === 'celebrate'
    ...
    return (<View style={styles.wrap}>
      ...
      <View style={styles.scene}>
        {scene ? (<Image source={scene} style={StyleSheet.absoluteFill} resizeMode="cover"/>) : null}
        ...
        {speaking ? (<Animated.View style={[
          ...
          </Animated.View>) : (<View style={styles.bubbleWrap} pointerEvents="none"/>)}
      </View>
    </View>);
}
const SCENE_H = 112;
