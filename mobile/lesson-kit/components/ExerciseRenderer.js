...
export const PASSIVE_KINDS = ['info', 'coldOpen', 'microInsight'];
export const isPassiveKind = (kind) => PASSIVE_KINDS.includes(kind);
/** Shared module renderer used by lessons, the Arena and Deep Case. */
export function renderExerciseByKind(exercise, phase, onChange) {
