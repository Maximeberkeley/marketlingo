...
export function MentorTipBubble({ mentor, tip, onDismiss, onTap, delay = 0 }) {
    ...
    return (<Animated.View style={[styles.container, { opacity, transform: [{ scale }, { translateY }] }]}>
      <TouchableOpacity onPress={onTap} activeOpacity={onTap ? 0.8 : 1} style={styles.bubble}>
        {/* Dismiss button */}
        ...
        {onTap && (<Text style={styles.tapHint}>Tap to chat</Text>)}
      </TouchableOpacity>
