...
export function AIConsentModal({ visible, kind, onAccept, onDecline }) {
    const isVoice = kind === 'voice';
    return (<Modal visible={visible} transparent animationType="fade" onRequestClose={onDecline}>
      <View style={styles.backdrop}>
        <View style={styles.card}>
          ...
          <TouchableOpacity onPress={() => Linking.openURL('https://market-verse.com/privacy')} activeOpacity={0.7}>
