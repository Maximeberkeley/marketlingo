...
export function DemoLesson({ onSignUp, onClose }: DemoLessonProps) {
  ...
  const goToStep = (next: DemoStep) => {
    animateTransition(() => setStep(next));
  };
      ...
      <Animated.View style={[styles.content, { transform: [{ translateX: slideAnim }] }]}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          {step === 'intro' && (
            <View style={styles.stepContainer}>
              ...
              <Text style={styles.introSubtitle}>
                2 slides + 1 quiz from the AI market.{'\n'}Earn real XP that carries into your account.
              </Text>
              <View style={styles.introBadges}>
                <View style={styles.introBadge}>
                  <Text style={styles.introBadgeText}>🤖 AI Market</Text>
                </View>
                <View style={styles.introBadge}>
                  <Text style={styles.introBadgeText}>⏱ 3 min</Text>
                </View>
                <View style={styles.introBadge}>
                  <Text style={styles.introBadgeText}>⚡ Up to 100 XP</Text>
                </View>
              </View>
          ...
          {step === 'slide1' && (
            <View style={styles.stepContainer}>
              <View style={styles.slideTag}>
                <Text style={styles.slideTagText}>SLIDE 1 OF 2</Text>
              </View>
              ...
              <TouchableOpacity
                ...
                onPress={() => { awardXP(25); goToStep('slide2'); }}
                activeOpacity={0.8}
              >
          ...
          {step === 'slide2' && (
            <View style={styles.stepContainer}>
              <View style={styles.slideTag}>
                <Text style={styles.slideTagText}>SLIDE 2 OF 2</Text>
              </View>
              ...
              <TouchableOpacity
                style={styles.primaryBtn}
                onPress={() => { awardXP(25); goToStep('quiz'); }}
                activeOpacity={0.8}
              >
          ...
          {step === 'quiz' && (
            <View style={styles.stepContainer}>
              <View style={[styles.slideTag, { backgroundColor: 'rgba(251, 191, 36, 0.15)' }]}>
                <Text style={[styles.slideTagText, { color: '#FBBF24' }]}>QUIZ</Text>
              </View>
                ...
                {DEMO_QUIZ.options.map((opt, idx) => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      activeOpacity={0.7}
                    >
                      <View style={[styles.quizLetter, showResult && isCorrect && { backgroundColor: 'rgba(34,197,94,0.2)' }]}>
            ...
            <View style={styles.stepContainer}>
              ...
              <View style={styles.feedbackBox}>
                <Text style={styles.feedbackText}>
                  {DEMO_QUIZ.options[selectedQuiz!]?.feedback}
                </Text>
              </View>
...
const xpStyles = StyleSheet.create({
  ...
  burstText: { fontSize: 14, fontWeight: '700', color: '#FBBF24' },
});
...
const styles = StyleSheet.create({
  ...
  xpChipText: { fontSize: 13, fontWeight: '700', color: '#FBBF24' },
  ...
  slideTagText: { fontSize: 10, fontWeight: '700', color: '#4ADE80', letterSpacing: 0.8 },
  slideTitle: { fontSize: 22, fontWeight: '700', color: COLORS.textPrimary, lineHeight: 28, marginBottom: 12 },
  slideDivider: { height: 2, backgroundColor: 'rgba(139, 92, 246, 0.3)', borderRadius: 1, marginBottom: 14 },
  ...
  quizOptionSelected: { borderColor: 'rgba(139, 92, 246, 0.5)' },
  quizOptionCorrect: { borderColor: 'rgba(34, 197, 94, 0.5)', backgroundColor: 'rgba(34, 197, 94, 0.08)' },
  quizOptionWrong: { borderColor: 'rgba(239, 68, 68, 0.5)', backgroundColor: 'rgba(239, 68, 68, 0.08)' },
  quizLetter: {
    width: 32,
    height: 32,
    borderRadius: 16,
  ...
  gateXPAmount: { fontSize: 22, fontWeight: '800', color: '#FBBF24', marginBottom: 4 },
