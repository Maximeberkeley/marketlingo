...
export function FeatureGate({ children, featureName, showLockBadge = true, overlayMode = true }: FeatureGateProps) {
...
const styles = StyleSheet.create({
  overlayContainer: { position: 'relative', borderRadius: 18, overflow: 'hidden' },
  blurredContent: { opacity: 0.35 },
  lockOverlay: {
    position: 'absolute', top: 0, left: 0, right: 0, bottom: 0,
    alignItems: 'center', justifyContent: 'center',
    backgroundColor: 'rgba(255,255,255,0.6)', borderRadius: 18, gap: 6,
  },
  lockIconCircle: {
    width: 56, height: 56, borderRadius: 28,
    backgroundColor: COLORS.accentSoft, alignItems: 'center', justifyContent: 'center', marginBottom: 4,
  },
  lockTitle: { fontSize: 15, fontWeight: '600', color: COLORS.textPrimary },
  lockSubtitle: { fontSize: 12, color: COLORS.textMuted },
  proBadge: {
  ...
  replaceContainer: { alignItems: 'center', justifyContent: 'center', paddingVertical: 40, gap: 8 },
  lockIconCircleLarge: {
    width: 72, height: 72, borderRadius: 36,
    backgroundColor: COLORS.warningSoft, alignItems: 'center', justifyContent: 'center', marginBottom: 8,
  },
  replaceTitle: { fontSize: 17, fontWeight: '600', color: COLORS.textPrimary },
  replaceSubtitle: { fontSize: 13, color: COLORS.textMuted, marginBottom: 8 },
  goProChip: { backgroundColor: COLORS.warningSoft, borderRadius: 20, paddingHorizontal: 16, paddingVertical: 8 },
  goProChipText: { color: COLORS.warning, fontSize: 14, fontWeight: '600' },
});
