...
export function ReviewSession({ items, onGrade, onComplete, marketName }) {
    ...
    if (!item || completedCount >= items.length) {
        return (<View style={[styles.container, { paddingTop: insets.top + 20 }]}>
    ...
    return (<View style={[styles.container, { paddingTop: insets.top + 16 }]}>
      ...
      <View style={styles.card}>
        ...
        {item.review_count > 0 && (<View style={styles.metaRow}>
        ...
        {!showAnswer ? (<TouchableOpacity style={styles.revealBtn} onPress={() => setShowAnswer(true)} activeOpacity={0.8}>
            <Text style={styles.revealBtnText}>Tap to recall — how well do you remember?</Text>
          </TouchableOpacity>) : (<View style={styles.gradeButtons}>
            <Text style={styles.gradeLabel}>How well did you recall this?</Text>
            <View style={styles.gradeRow}>
              <TouchableOpacity style={[styles.gradeBtn, styles.gradeForgot]} onPress={() => handleGrade(0)}>
                <Text style={styles.gradeBtnEmoji}></Text>
                <Text style={[styles.gradeBtnText, { color: '#EF4444' }]}>Forgot</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.gradeBtn, styles.gradeHard]} onPress={() => handleGrade(1)}>
                <Text style={styles.gradeBtnEmoji}></Text>
                <Text style={[styles.gradeBtnText, { color: '#F97316' }]}>Hard</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.gradeBtn, styles.gradeGood]} onPress={() => handleGrade(2)}>
                <Text style={styles.gradeBtnEmoji}></Text>
                <Text style={[styles.gradeBtnText, { color: '#22C55E' }]}>Good</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.gradeBtn, styles.gradeEasy]} onPress={() => handleGrade(3)}>
                <Text style={styles.gradeBtnEmoji}></Text>
