...
const styles = StyleSheet.create({
  ...
  companyName: { fontSize: 18, fontWeight: '700', color: '#F1F5F9' },
  tickerBadge: {
    paddingHorizontal: 8,
    paddingVertical: 2,
  ...
  industryRoleText: { fontSize: 14, color: '#CBD5E1', lineHeight: 20 },
  statsGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  ...
  statLabel: { fontSize: 9, color: '#64748B', fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
  statValue: { fontSize: 13, color: '#E2E8F0', fontWeight: '600' },
  marketCapCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  marketCapLabel: { fontSize: 10, color: '#64748B', fontWeight: '600', letterSpacing: 0.5 },
  ...
  keyStatLabel: { fontSize: 9, color: '#64748B', textAlign: 'center', marginTop: 4 },
  ...
  productChipText: { fontSize: 12, color: '#CBD5E1' },
  insightSlide: {
    flex: 1,
    gap: 20,
    paddingTop: 8,
  ...
  insightTitle: { fontSize: 22, fontWeight: '700', color: '#F1F5F9', lineHeight: 30 },
  insightContent: { fontSize: 16, color: '#94A3B8', lineHeight: 26 },
  highlightBadge: {
  ...
  navBtnText: { fontSize: 18, color: '#E2E8F0' },
  slideCounter: { fontSize: 13, color: '#64748B' },
});
