...
export function getDebriefQuestion(lessonTitle) {
...
export function MentorDebrief({ mentorName, mentorEmoji, mentorImage, lessonTitle, debriefQuestion, onOpenChat, onDismiss, }) {
