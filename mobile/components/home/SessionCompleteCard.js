...
export function SessionCompleteCard({ dayNumber, marketName, marketEmoji, xpEarned, streak, lessonTitle, totalXP, stageName, onContinue, onDismiss, onAskMentor, mentorName, }) {
    ...
    return (<Animated.View style={[styles.overlay, { opacity: opacityAnim }]}>
      ...
      <Animated.View style={[styles.card, { transform: [{ scale: scaleAnim }] }]}>
        ...
        <View style={styles.actions}>
          ...
          {onAskMentor && (<TouchableOpacity style={styles.mentorBtn} onPress={onAskMentor} activeOpacity={0.7}>
