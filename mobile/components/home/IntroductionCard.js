...
export function IntroductionCard({ type, onStart, onDismiss }) {
    const content = introContent[type];
    return (<Modal visible animationType="fade" transparent>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.featuresList}>
              {content.features.map((feature, i) => (<View key={i} style={styles.featureRow}>
            ...
            <View style={styles.actions}>
              {onDismiss && (<TouchableOpacity onPress={onDismiss} style={styles.dismissBtn}>
                  <Text style={styles.dismissText}>Maybe Later</Text>
                </TouchableOpacity>)}
              <TouchableOpacity onPress={onStart} style={[styles.ctaBtn, { flex: onDismiss ? 1 : undefined, backgroundColor: content.gradient[0] }]}>
