...
export function StreakAtRisk({ streak, hoursLeft, onStartLesson, onDismiss }: StreakAtRiskProps) {
  ...
  useEffect(() => {
    ...
    // Shake after a delay for urgency
  ...
  const textColor =
    urgencyLevel === 'critical' ? '#FCA5A5' : urgencyLevel === 'warning' ? '#FDBA74' : '#FDE68A';
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        style={[
          styles.ctaBtn,
          urgencyLevel === 'critical' && { backgroundColor: '#EF4444' },
          urgencyLevel === 'warning' && { backgroundColor: '#F97316' },
          urgencyLevel === 'caution' && { backgroundColor: '#EAB308' },
        ]}
...
/**
 * Check if we should show the streak-at-risk warning.
 * Returns hours left until streak expires, or null if no risk.
 */
