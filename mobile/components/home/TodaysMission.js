...
function CircularProgress({ progress, size, strokeWidth, isCompleted, }) {
    ...
    return (<Animated.View style={{ width: size, height: size, opacity: fadeAnim }}>
      <View style={{
      ...
      <View style={{ width: size, height: size, position: 'absolute', overflow: 'hidden' }}>
        ...
        {degrees > 180 && (<View style={{ width: size / 2, height: size, position: 'absolute', left: 0, overflow: 'hidden' }}>
            <View style={{
                width: size, height: size, borderRadius: size / 2,
                borderWidth: strokeWidth, borderColor: accentColor,
...
export function TodaysMission({ dayNumber, totalDays = 180, lessonTitle, marketEmoji, marketName, xpReward, duration, progress, isCompleted, streak, onStart, onReview, onPractice, }) {
    ...
    return (<Animated.View style={[styles.container, { transform: [{ translateY: slideAnim }], opacity: opacityAnim }]}>
      ...
      <View style={styles.content}>
        <View style={styles.topRow}>
          ...
          {streak > 0 && (<View style={styles.streakBadge}>
        ...
        <View style={styles.mainRow}>
          <View style={styles.ringContainer}>
            ...
            <View style={styles.ringCenter}>
              {isCompleted ? (<Feather name="check" size={32} color={COLORS.success}/>) : (<>
        ...
        {isCompleted ? (<View style={styles.completedActions}>
          ...
          </View>) : (<Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
