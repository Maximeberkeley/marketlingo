 ...
 */
export function PulsingCTA({ label, title, slideCount, xpReward, onPress }) {
    ...
    return (<Animated.View style={{ opacity: opacityAnim, transform: [{ scale: Animated.multiply(enterAnim, pulseAnim) }] }}>
