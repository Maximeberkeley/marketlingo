...
export function StreakFreezeCard({ streak, canFreeze, freezesUsed, maxFreezes, isProUser, onUseFreeze, onDismiss, }) {
    ...
    return (<Animated.View style={[styles.container, { transform: [{ translateY: slideAnim }] }]}>
      ...
      {canFreeze && (<TouchableOpacity style={styles.freezeBtn} onPress={handleFreeze} activeOpacity={0.8}>
