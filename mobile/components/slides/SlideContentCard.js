...
export function SlideContentCard({ title, body, sources, slideIndex, totalSlides, stackTitle, marketId, }) {
    ...
    return (<View style={styles.container}>
      ...
      {slidePosition && (<SlideMascotCard position={slidePosition} slideIndex={slideIndex} totalSlides={totalSlides} marketId={marketId}/>)}
      ...
      <View style={styles.card}>
        ...
        {/* Sources */}
        {safeSources.length > 0 && (<View style={styles.sourcesSection}>
            <View style={styles.divider}/>
            <View style={styles.sourcesRow}>
              {safeSources.map((source, idx) => (<TouchableOpacity key={idx} style={styles.sourceChip} onPress={() => Linking.openURL(source.url)}>
