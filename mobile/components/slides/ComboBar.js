...
export function ComboBar({ combo, correctCount, totalAnswered }) {
    ...
    return (<Animated.View style={[styles.container, { transform: [{ translateY: slideIn }] }]}>
      {/* Combo streak */}
      ...
      {/* Multiplier badge */}
      {combo.multiplier > 1 && (<View style={[styles.multiplierBadge, { backgroundColor: multiplierColor + '18', borderColor: multiplierColor + '40' }]}>
