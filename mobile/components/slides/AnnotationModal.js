...
export function AnnotationModal({ visible, slideTitle, slideBody, onSave, onCancel }) {
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={handleCancel}>
          <TouchableOpacity activeOpacity={1} style={styles.card}>
            ...
            {/* Annotation input */}
            <TextInput style={styles.input} placeholder="What's your takeaway? What connects to something you know?" placeholderTextColor={COLORS.textMuted} value={annotation} onChangeText={setAnnotation} multiline autoFocus textAlignVertical="top"/>
            ...
            <View style={styles.actions}>
              ...
              <TouchableOpacity style={[styles.saveBtn, !annotation.trim() && { opacity: 0.4 }]} onPress={handleSave} disabled={!annotation.trim()}>
