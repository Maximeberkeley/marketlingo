...
export function WorldBanner({ marketId, day = 1, compact = false }) {
    const world = getMarketWorld(marketId);
    return (<LinearGradient colors={[world.colors[0], world.colors[1]]} style={[styles.wrap, compact && styles.compact]}>
