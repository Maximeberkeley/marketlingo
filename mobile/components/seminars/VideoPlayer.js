...
export function VideoPlayer({ videoUrl, isLocked, scheduledAt }) {
  ...
  `;
    return (<View style={styles.playerContainer}>
      <WebView source={{ html }} style={styles.webview} allowsInlineMediaPlayback mediaPlaybackRequiresUserAction={false} javaScriptEnabled/>
    </View>);
}
