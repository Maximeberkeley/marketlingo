...
import { LEO, getRandomMessage } from '../../lib/mascots';
import { COLORS } from '../../lib/constants';
const LEO_SIZE_MAP = { sm: 'sm', md: 'sm', lg: 'md' };
const ANIM_MAP = {
    idle: 'idle',
    thinking: 'thinking',
    correct: 'success',
...
export function MascotReaction({ state, showMessage = true, position = 'bottom-right', size = 'md', }) {
    ...
    return (<Animated.View style={[
      ...
      {showMessage && message && (<View style={[styles.messageBubble, { backgroundColor: getColor() + '20', borderColor: getColor() + '40' }]}>
