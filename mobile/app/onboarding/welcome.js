...
export default function WelcomeScreen() {
    ...
    return (<View style={[styles.screen, { paddingTop: insets.top + 24, paddingBottom: insets.bottom + 24 }]}>
      ...
      <View style={styles.actions}>
        {demoStatus === 'completed' ? (<TouchableOpacity style={styles.primary} onPress={() => void chooseIndustry()} activeOpacity={0.88}>
            <Text style={styles.primaryText}>Save My Progress & Choose Industry</Text>
          </TouchableOpacity>) : (<TouchableOpacity style={styles.primary} onPress={() => router.push('/demo')} activeOpacity={0.88}>
            <Text style={styles.primaryText}>Try the Demo Lesson (+20 XP)</Text>
          </TouchableOpacity>)}
        {demoStatus !== 'completed' && (<TouchableOpacity style={styles.secondary} onPress={() => void chooseIndustry()} activeOpacity={0.8}>
