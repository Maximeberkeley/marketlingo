...
export default function FocusScreen() {
    ...
    return (<ScrollView style={styles.flex} contentContainerStyle={{ paddingTop: insets.top + 12, paddingBottom: insets.bottom + 48 }}>
      ...
      {focus.options.map(option => {
            ...
            return (<TouchableOpacity key={option.key} style={[styles.card, active && styles.cardActive]} onPress={() => pick(option)} activeOpacity={0.85}>
      ...
      {focus.focusKey ? (<TouchableOpacity style={styles.clear} onPress={async () => {
                triggerHaptic('light');
                await focus.clear();
            }}>
