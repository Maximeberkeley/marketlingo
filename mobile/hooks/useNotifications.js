...
export function useNotifications() {
    ...
    const scheduleStreakReminder = useCallback(async (hoursUntilExpiry) => {
        if (!isSupported || !preferences.streakReminders)
            return;
        try {
    ...
    const scheduleRollingReminders = useCallback(async (lessonCompletedToday) => {
