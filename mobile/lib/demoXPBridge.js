 ...
 */
export async function saveDemoXP(xp) {
    try {
 ...
 */
export async function saveDemoMarket(market) {
    try {
 ...
 */
export async function getDemoXP() {
    try {
 ...
 */
export async function applyDemoXP(userId, marketId) {
    try {
