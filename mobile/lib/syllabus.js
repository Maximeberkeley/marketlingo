...
export const isConsolidationDay = (day) => day > 0 && day % 7 === 0;
export function seasonThemes(marketId) {
...
export function syllabusDay(marketId, day) {
...
export function dayPromise(marketId, day) {
