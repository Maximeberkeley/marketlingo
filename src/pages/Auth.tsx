...
export default function AuthPage() {
  ...
  return <div className="min-h-[100dvh] flex flex-col items-center justify-center px-4 bg-gradient-to-b from-bg-0 to-bg-1 overflow-x-hidden overflow-y-auto keyboard-aware">
      <AnimatePresence mode="wait">
        ...
        duration: 0.3
          ...
          delay: 0.3,
          duration: 0.4
        }} className="text-body text-text-secondary text-center mb-12 max-w-xs">Become fluent in one market in 6 months.</motion.p>
          ...
          </motion.div> : <motion.div key="email-form" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        duration: 0.3
            ...
            {/* Back Button */}
            <button onClick={() => setMode("options")} className="flex items-center gap-2 text-text-secondary mb-8 hover:text-text-primary transition-colors">
              <ArrowLeft size={20} />
